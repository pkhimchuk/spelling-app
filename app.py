...
st.markdown(
    ...
    /* =========================================================
       LETTER GRID
       Keep ONLY the letter buttons in a 5-column grid.
       This is intentionally scoped to .st-key-letter_grid so
       Erase / Submit / other Streamlit columns are unaffected.
       ========================================================= */
...
if not st.session_state.submitted:
    ...
    # Dedicated container so the grid CSS doesn't affect
    # Erase / Submit / other Streamlit columns.
    with st.container(key="letter_grid"):
...
# ---------------------------------------------------------
    ...
    if st.session_state.is_correct:import json
import os
import random
from datetime import datetime
